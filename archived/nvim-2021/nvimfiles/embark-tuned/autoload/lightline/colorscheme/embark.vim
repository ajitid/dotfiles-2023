...
let s:p.tabline.tabsel  = [ [ s:lfc.clouds, s:lfc.eclipse ] ]
let s:p.tabline.middle  = [ [ s:lfc.clouds, s:lfc.bg_dark ] ]
" let s:p.tabline.right   = [ [ s:lfc.bg_dark, s:lfc.norm ] ]
let s:p.tabline.right    = [ [ s:lfc.clouds, s:lfc.bg_dark ] ]
" let s:p.tabline.right   = [ [ s:lfc.clouds, s:lfc.eclipse ] ]

" Normal mode
let s:p.normal.left     = [ [ s:lfc.bg_dark, s:lfc.norm, 'bold' ],  [ s:lfc.clouds, s:lfc.eclipse ] ]
let s:p.normal.middle   = [ [ s:lfc.clouds, s:lfc.bg_dark ] ]
let s:p.normal.right    = [ [ s:lfc.bg_dark, s:lfc.norm, 'bold' ],  [ s:lfc.clouds, s:lfc.eclipse ] ]
let s:p.normal.error    = [ [ s:lfc.red, s:lfc.bg_dark ] ]
let s:p.normal.warning  = [ [ s:lfc.yellow, s:lfc.bg_dark ] ]

" Visual mode
let s:p.visual.left     = [ [ s:lfc.bg_dark, s:lfc.purple, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_purple ] ]
let s:p.visual.right    = [ [ s:lfc.bg_dark, s:lfc.purple, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_purple ] ]

" Insert mode
let s:p.insert.left    = [ [ s:lfc.bg_dark, s:lfc.blue, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_blue ] ]
let s:p.insert.right   = [ [ s:lfc.bg_dark, s:lfc.blue, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_blue ] ]

" Replace mode
let s:p.replace.left     = [ [ s:lfc.bg_dark, s:lfc.red, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_red ] ]
let s:p.replace.right    = [ [ s:lfc.bg_dark, s:lfc.red, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_red ] ]

" Inactive split
let s:p.inactive.left   = [ [ s:lfc.dark_clouds, s:lfc.bg_dark ], [ s:lfc.eclipse, s:lfc.bg_dark ] ]
...
" Command mode
let s:p.command.left     = [ [ s:lfc.bg_dark, s:lfc.green, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_green ] ]
let s:p.command.right    = [ [ s:lfc.bg_dark, s:lfc.green, 'bold' ],  [ s:lfc.bg_dark, s:lfc.dark_green ] ]
