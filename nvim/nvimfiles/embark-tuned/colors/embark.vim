...
call s:h("CursorLineNr",  {"bg": s:bg, "fg": s:dark_blue })
...
" TODO: only change underline color for warning and errror
call s:h ("LspDiagnosticsUnderlineWarning", {"cterm": "undercurl", "gui": "undercurl", "fg": s:yellow})
call s:h ("LspDiagnosticsUnderlineError", {"cterm": "undercurl", "gui": "undercurl", "fg": s:red})
